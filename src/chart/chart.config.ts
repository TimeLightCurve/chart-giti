...
export const getDefaultConfig = (): FullChartConfig => ({
	...
	colors: {
		...
		areaTheme: {
			...
			circleStart: 'rgba(169,38,251,1)',
			circleStop: 'rgba(169,38,251,1)',
...
export interface FullChartColors {
	...
	crossTool: {
		circleStart: string | CanvasGradient | CanvasPattern;
		circleStop: string | CanvasGradient | CanvasPattern;
		lineColor: string;
		labelBoxColor: string;
		labelTextColor: string;
	};
...
export type YAxisLabelAppearanceType = 'badge'| 'badgeSelect' | 'rectangle' | 'plain';
